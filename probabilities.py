...
probability_dict = {
    ...
    "Cabin Temperature": {
        "Excess Water Vapor Pressure in Cabin": {
            ...
            'value_ranges': measurement_ranges["Cabin Temperature"]
        },
    ...
    "Humidity": {
        "CDRA Failure": {
            ...
            'value_ranges': measurement_ranges["Humidity"]
        },
        "Excess Water Vapor Pressure in Cabin": {
            'probabilities': {
                True: { # probabilities when the anomaly is present
    ...
    "ppCO2": {
        "Biological Filter Saturation": {
            ...
            'value_ranges': measurement_ranges["ppCO2"]
        },
        "CDRA Failure": {
            'probabilities': {
                True: { # probabilities when the anomaly is present
    ...
    "ppH2": {
        "Excess Gas Leak": {
            ...
            'value_ranges': measurement_ranges["ppH2"]
        },
    },
    "ppN2": {
        "Loss of Pressure": {
            ...
            'value_ranges': measurement_ranges["ppN2"]
        },
        "N2 Tank Burst": {
            'probabilities': {
                True: { # probabilities when the anomaly is present
    ...
    "ppO2": {
        "Biological Filter Saturation": {
            ...
            'value_ranges': measurement_ranges["ppO2"]
        },
        "CDRA Failure": {
            'probabilities': {
                True: { # probabilities when the anomaly is present
    ...
    "Pressure": {
        "Loss of Pressure": {
            ...
            'value_ranges': measurement_ranges["Pressure"]
        },
        "N2 Tank Burst": {
            'probabilities': {
                True: { # probabilities when the anomaly is present
    ...
    "Total Cabin Pressure": {
        "Loss of Pressure": {
            ...
            'value_ranges': measurement_ranges["Total Cabin Pressure"]
        },
        "N2 Tank Burst": {
            'probabilities': {
                True: { # probabilities when the anomaly is present
